...
public class Model {
    ...
    // 第一个listview的图片数据数组
    public static int[] LISTVIEWIMG = new int[]{R.drawable.fx_image_wb,
            R.drawable.fx_image_wb, R.drawable.fx_image_wb,
            R.drawable.fx_image_wb, R.drawable.fx_image_wb,
            R.drawable.fx_image_wb, R.drawable.fx_image_wb,
            R.drawable.fx_image_wb, R.drawable.fx_image_wb,
            R.drawable.fx_image_wb, R.drawable.fx_image_wb,
            R.drawable.fx_image_wb};
    // 第一个listview的文本数据数组
    ...
    public static final String[] toolsList = {"胶带", "安防监控系统", "消防设施", "黏胶带",
            "劳保防护用品", "过滤材料", "急救援助用品", "工位器具", "公共安全设备和材料"};
    public static final String[] wjjdList = {"电动工具", "手动工具", "气动工具", "园艺工具",
            "润滑工具", "起重工具", "汽保工具", "布线工具","其他工具"};
    public static final int[] iconList = {R.drawable.products_detail_head_bg,
            R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg,
            R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg,
            R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg,
            R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg,
            R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg, R.drawable.products_detail_head_bg,
