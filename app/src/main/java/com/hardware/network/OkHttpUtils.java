...
import com.hardware.network.builder.GetBuilder;
import com.hardware.network.builder.PostFileBuilder;
import com.hardware.network.builder.PostFormBuilder;
import com.hardware.network.builder.PostStringBuilder;
import com.hardware.network.callback.Callback;
import com.hardware.network.https.HttpsUtils;
import com.hardware.network.request.RequestCall;
...
public class OkHttpUtils {
    ...
    private OkHttpUtils() {
        ...
        mOkHttpClient.setConnectTimeout(60000, TimeUnit.SECONDS);
        //cookie enabled
